...
function TeamWheel({items, setChoosenItem, setSavedItem}) {
  ...
  return (
    <div className="StyledBox-sc-13pk1d4-0 iUSIPZ Box__TurntableBox-sc-wbjuwj-0 lapiXs" style={{minWidth:"auto",minHeight:"auto",height:'300px'}}>
      ...
      <div id="mainbox" className="mainbox">
        ...
        <div id="box" className="box" style={{width:"300px",height:"300px"}}>
          <div className="box1">
            {itemsShow}
          </div>
        </div> 
        <button className="spin" onClick={() => rotateFunction()} id="Startbut" disabled>
          GO!
        </button>
      </div>
    </div>
