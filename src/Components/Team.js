...
import TeamWheel from '../Wheel/TeamWheel'
import Modal from 'react-modal';
import Select from 'react-select';
import { TeamBoard } from '../Wheel/TeamBoard'
import { Nav } from './Nav';
...
function Team() {
  ...
  useEffect(()=>{
    if(!uploadAreastatus){
      ...
      document.getElementById('UploadImageArea').style.display = 'initial';
    }
  },[uploadAreastatus])
  ...
  const [numGroup, setNumGroup] = useState(1);
  const [numPeople, setNumPeople] = useState(1);

  const handleInput1 = (event) => {
    const val = parseInt(event.target.value)
    setNumGroup(val);
    setNumPeople(Math.ceil(images.length/val));
  }

  const handleInput2 = (event) => {
    const val = parseInt(event.target.value) 
    setNumGroup(Math.ceil(images.length/val));
    setNumPeople(val)
  }

  useEffect(()=>{
    console.log(balanceGender,numGroup,numPeople);
  },[balanceGender,numGroup,numPeople])
  ...
  <div className="StyledBox-sc-13pk1d4-0 fbINvl Box__BGContainer-sc-wbjuwj-1 gCRmNJ"><div className="Box__FullScreen-sc-wbjuwj-5 eIqCas fullscreen"><div className="StyledBox-sc-13pk1d4-0 hmgtJj PageTitle__TitleAdsBox-sc-1975ioo-0 fGoyyN"><div className="StyledBox-sc-13pk1d4-0 iopyRj PageTitle__TitleParagraphBox-sc-1975ioo-1 iwHUIE"><h2 className="StyledHeading-sc-1rdh4aw-0 CyAkj PageTitle__Title-sc-1975ioo-3 cIYJln">Picker Wheel</h2><p className="StyledParagraph-sc-tbetod-0 dtPhzk PageTitle__ParagraphTitle-sc-1975ioo-4 bhmHtD">Help you to make a random decision</p></div><div id="pageHeader" className="StyledBox-sc-13pk1d4-0 blmKUv PageTitle__PageHeaderBox-sc-1975ioo-2 iDiljY"></div></div><div className="StyledBox-sc-13pk1d4-0 iopyRj Box__ContainerTool-sc-wbjuwj-2 eyoZDu"><div className="StyledBox-sc-13pk1d4-0 bkPboX Box__WheelWhiteBox-sc-wbjuwj-3 vkunp">
  <div className="StyledBox-sc-13pk1d4-0 fArnBw Box__WheelBox-sc-wbjuwj-4 dIOerX" style={{flexWrap:'nowrap'}}>




<div className="StyledBox-sc-13pk1d4-0 iKCmyT random-team-generator__EqualBox-sc-1l0kp98-2 eHGnOp" style={{margin:"1em",width:"40%"}}>
  <div className="StyledBox-sc-13pk1d4-0 iKCmyT ReactRTG__Container-sc-12a3gm6-0 jgxopw">
    <div className="StyledBox-sc-13pk1d4-0 iopyRj">
      <h3 className="StyledHeading-sc-1rdh4aw-0 eBEytx">3. RESULT</h3>

      <div className="StyledBox-sc-13pk1d4-0 EUfLa1 ReactRTG__GroupsContainer-sc-12a3gm6-1 lRdFO">
        {teams.map((team, index)=>{
          return (
            <div className="StyledBox-sc-13pk1d4-0 iopyRj group__Container-sc-16moxwg-0 heWXlE" style={{backgroundColor: bgcolor[index%5], border: `2px solid ${bgcolor[index%5]}`}}>
              <div className="StyledBox-sc-13pk1d4-0 igjEcZ">
                <h5 className="StyledHeading-sc-1rdh4aw-0 hxgTxw group__Title-sc-16moxwg-4 hfMUQr">{team.name}</h5>
                <div className="StyledBox-sc-13pk1d4-0 cYrRgn">
                  <span className="StyledText-sc-1sadyjn-0 fGKRcj group__TextNumGroup-sc-16moxwg-2 fzrfdO">{team.content.length}</span>
                </div>
              </div>
              <div className="StyledBox__StyledBoxGap-sc-13pk1d4-1 hiAsyw"></div>
              <div className="StyledBox-sc-13pk1d4-0 cMMyrC group__GroupBox-sc-16moxwg-1 jHcXCw">

                {team.content.map((item)=>{

                  return (
                    <>
                      <div className="StyledBox-sc-13pk1d4-0 dOgBQu">
                        <div className={"StyledBox-sc-13pk1d4-0 kaaldD Icon__Container-sc-dp9rlk-0 kWtXFV MyselectCSS" + (item.gender)}>
                          <img alt="UnisexIconWhite" src={genderimg[0][item.gender-1]} className="StyledImage-sc-ey4zx9-0 jFAHLS"/>
                        </div>
                        <div className="StyledBox__StyledBoxGap-sc-13pk1d4-1 epPYSv"></div>
                        <span className="StyledText-sc-1sadyjn-0 gHGdZI group__TextGroup-sc-16moxwg-3 gnttSU">{item.content}</span>
                      </div>
                      <div className="StyledBox__StyledBoxGap-sc-13pk1d4-1 BBdZX"></div>
                    </>
                  )
                })}
  ...
  <div style={{display:'flex', flexDirection: 'column'}}>
    <div className='StyledBox-sc-13pk1d4-0 dVMaZH random-team-generator__ControllerBox-sc-1l0kp98-3 fHKcYT' style={{width:'300px'}}>
      <div className="StyledBox-sc-13pk1d4-0 iKCmyT controller__Container-sc-7naqfd-1 ljEayv">
        <div className="StyledBox-sc-13pk1d4-0 cfaefn">
          <h3 className="StyledHeading-sc-1rdh4aw-0 cyDjdt">2. CONTROLLER</h3>
          <button className="StyledButton-sc-323bzc-0 iiGFSH TooltipButton__Button-sc-rmqt3w-0 hITtYK" type="button">
            <svg aria-label="Group" viewBox="0 0 24 24" className="StyledIcon-ofa7kd-0 gDgYUv">
              <path fill="none" stroke="#000" stroke-width="2" d="M12,13 C14.209139,13 16,11.209139 16,9 C16,6.790861 14.209139,5 12,5 C9.790861,5 8,6.790861 8,9 C8,11.209139 9.790861,13 12,13 Z M6,22 L6,19 C6,15.6862915 8.6862915,13 12,13 C15.3137085,13 18,15.6862915 18,19 L18,22 M13,5 C13.4037285,3.33566165 15.0151447,2 17,2 C19.172216,2 20.98052,3.790861 21,6 C20.98052,8.209139 19.172216,10 17,10 L16,10 L17,10 C20.287544,10 23,12.6862915 23,16 L23,18 M11,5 C10.5962715,3.33566165 8.98485529,2 7,2 C4.82778404,2 3.01948003,3.790861 3,6 C3.01948003,8.209139 4.82778404,10 7,10 L8,10 L7,10 C3.71245602,10 1,12.6862915 1,16 L1,18">
              </path>
            </svg>
          </button>
        </div>
        <div className="StyledBox__StyledBoxGap-sc-13pk1d4-1 hiAsyw"></div>
        <div className="StyledBox-sc-13pk1d4-0 iKCmyT">
        <div className="StyledBox-sc-13pk1d4-0 ySyYP">
        <span className="StyledText-sc-1sadyjn-0 gHGdZI">Balance gender distribution</span>
        <label className="StyledCheckBox__StyledCheckBoxContainer-sc-1dbk5ju-1 jaIRxG">
        <div className="StyledBox-sc-13pk1d4-0 bmLbIr StyledCheckBox-sc-1dbk5ju-6 huQjDV">
          <input className="StyledCheckBox__StyledCheckBoxInput-sc-1dbk5ju-2 QksDn controller__CheckBox-sc-7naqfd-0 iMbmhC" type="checkbox" onClick={() => setBalanceGender(!balanceGender)}/>
        </div>
        </label>
        </div>
        <div className="StyledBox__StyledBoxGap-sc-13pk1d4-1 hiAsyw">
        </div>
        <div className="StyledBox-sc-13pk1d4-0 ySyYP">
        <span className="StyledText-sc-1sadyjn-0 gHGdZI">Number of groups</span>
        <div className="StyledBox-sc-13pk1d4-0 iopyRj">
        <div className="StyledTextInput__StyledTextInputContainer-sc-1x30a0s-1 imHyBg">
        <input autocomplete="off" type="number" min="1" max="100" className="StyledTextInput-sc-1x30a0s-0 bLqQCR controller__NumInput-sc-7naqfd-2 ldjKSI" onChange={handleInput1} value={numGroup}/>
        </div>
        </div>
        </div>
        <div className="StyledBox__StyledBoxGap-sc-13pk1d4-1 hiAsyw">
        </div>
        <span className="StyledText-sc-1sadyjn-0 fHBnhb">OR (Set either one)</span>
        <div className="StyledBox__StyledBoxGap-sc-13pk1d4-1 hiAsyw">
        </div>
        <div className="StyledBox-sc-13pk1d4-0 ySyYP">
        <span className="StyledText-sc-1sadyjn-0 gHGdZI">Number of people/group</span>
        <div className="StyledBox-sc-13pk1d4-0 iopyRj">
        <div className="StyledTextInput__StyledTextInputContainer-sc-1x30a0s-1 imHyBg">
          <input autocomplete="off" type="number" min="1" max="500" className="StyledTextInput-sc-1x30a0s-0 bLqQCR controller__NumInput-sc-7naqfd-2 ldjKSI" onChange={handleInput2} value={numPeople}/>
        </div>
        </div>
        </div>
        </div>
        ...
        <div className="StyledBox-sc-13pk1d4-0 dAeNYX mybutdiv">
        <button className="StyledButton-sc-323bzc-0 htcorO controller__StartButton-sc-7naqfd-3 mIbRG startbut" type="button" onClick={onStart}>START</button>
        </div>
      </div>
    </div>
    <TeamWheel items={images} setChoosenItem={setChoosenItem} setSavedItem={setSavedItem}/>
  </div>


<div className="StyledBox-sc-13pk1d4-0 iOLvMP InputBox__StyledInputBox-sc-93rbkl-0 dqFYEQ" id="UploadImageArea">
<div className="StyledBox-sc-13pk1d4-0 hCJgDx Title__TitleBox-sc-1unxr3s-0 dPLYnr" style={{display: "none"}}><div className="StyledTextInput__StyledTextInputContainer-sc-1x30a0s-1 imHyBg"><input autoComplete="off" placeholder="Title: Type Here..." className="StyledTextInput-sc-1x30a0s-0 gifcRh Title__TitleInput-sc-1unxr3s-1 wPHEQ" value=""/></div></div><div className="StyledBox-sc-13pk1d4-0 iopyRj Common__RelativeBox-sc-1fs44vl-0 xIhyt"><div className="StyledBox-sc-13pk1d4-0 hPqJjE Inputs__Container-sc-1562xvn-0 jFwSP"><div className="StyledBox-sc-13pk1d4-0 gpvHhv"><div className="StyledBox-sc-13pk1d4-0 hKDqav"><h3 className="StyledHeading-sc-1rdh4aw-0 gGUfFh">1. INPUTS [{images.length}]</h3></div><div className="StyledBox-sc-13pk1d4-0 cvKuOz">
...
<button className="StyledButton-sc-323bzc-0 iiGFSH TooltipButton__Button-sc-rmqt3w-0 eQzZxI" type="button" onClick={() => toggleUploadArea()}>
  <svg aria-label="View" viewBox="0 0 24 24" className="StyledIcon-ofa7kd-0 eqwWhH"><path fill="none" stroke="#000" stroke-width="2" d="M12,21 C7,21 1,16 1,12 C1,8 7,3 12,3 C17,3 23,8 23,12 C23,16 17,21 12,21 Z M12,7 C9.23875,7 7,9.23875 7,12 C7,14.76125 9.23875,17 12,17 C14.76125,17 17,14.76125 17,12 C17,9.23875 14.76125,7 12,7 L12,7 Z"></path></svg></button>
...
<TeamBoard images={images} setImages={setImages} choosenItem={choosenItem} setChoosenItem={setChoosenItem} savedItem={savedItem} setSavedItem={setSavedItem}/>
</div>
    ...
    <path fill="none" stroke="#000" stroke-width="2" d="M12,17 C9.27272727,17 6,14.2222222 6,12 C6,9.77777778 9.27272727,7 12,7 C14.7272727,7 18,9.77777778 18,12 C18,14.2222222 14.7272727,17 12,17 Z M11,12 C11,12.55225 11.44775,13 12,13 C12.55225,13 13,12.55225 13,12 C13,11.44775 12.55225,11 12,11 C11.44775,11 11,11.44775 11,12 Z M20,5 L4,19"></path></svg><div className="StyledBox__StyledBoxGap-sc-13pk1d4-1 bLzgru"></div>1. INPUTS</div></button></div>
